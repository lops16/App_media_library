...
@WebServlet("/FrmModificarSerie")
public class FrmModificarSerie extends HttpServlet implements I_Constantes{
	private static final long serialVersionUID = 1L;
       
   
    public FrmModificarSerie() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher(JSP_FRMMOD_SERIE).forward(request, response);
